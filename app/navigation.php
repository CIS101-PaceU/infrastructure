    ...
    <div class="side-nav--links">
      ...
      <ul>
         ...
         <li class="assn-title"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> ASSIGNMENTS</li>
           ...
           <li><a class="nav-button <?php if ($activePage == 'reporting') { echo 'nav-active'; } else { echo 'nav-button'; } ?>" href="../reporting/"><i class="fa fa-area-chart" aria-hidden="true"></i> REPORTING</a></li>
