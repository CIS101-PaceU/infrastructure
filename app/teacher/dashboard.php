    ...
    <div class="main-container">
        <div class="class-content">
            ...
            $result = $conn->query($latestPostSQL);
                        ...
                        // output data of each row
                        while($row = $result->fetch_assoc()) {
                        echo "<h3>" . $row["assignmentTitle"] . "</h3>" . "<span class='bold-text'>Due Date: " . $row["dueDate"] . "</span><br>Date Posted: " . $row["availableDate"] . "<br>" . "<br>" . $row["assignmentDescription"] . "<br><a href=''>Edit Assignment</a> | <a href='assignmentSubmissions.php'>View and/or Grade Submissions</a>";
                        }
                    } else {
